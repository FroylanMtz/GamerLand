      ...
      success: function (returndata) {        
        ...
        if(returndata[0].error==0){
          ...
          for (i = 0; i < returndata[1].length; i++) {
            if (contador%2!=0) {
            rJson = rJson + " <tbody>  <tr style=background-color:#f2f2f2; id='tr"+returndata[1][i].idRenta+"'><td>" + returndata[1][i].usuario + "</td><td>" + returndata[1][i].nombreCon + "</td><td>" + returndata[1][i].nombreJu + "</td><td>" + returndata[1][i].fecha + "</td><td>" + returndata[1][i].hora + "</td>";
            ...
            rJson = rJson + " <tbody>  <tr style=background-color:#A9ABAA; id='tr"+returndata[1][i].idRenta+"'><td>" + returndata[1][i].usuario + "</td><td>" + returndata[1][i].nombreCon + "</td><td>" + returndata[1][i].nombreJu + "</td><td>" + returndata[1][i].fecha + "</td><td>" + returndata[1][i].hora + "</td>";
            if(returndata[1][i].promocionActiva == 1)
              rJson = rJson + "<td> Promoción 1 </td>";
            else
              rJson = rJson + "<td> Promoción 2 </td>";
