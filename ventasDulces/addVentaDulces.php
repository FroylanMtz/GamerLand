  ...
  <body class="hold-transition register-page">
    <div class="register-box">
        <div class="register-logo">
            <a href="ventaDulces.php" id="logo"> <img class="center-block " src="../Public/img/logo2.jpeg" width="250px" height="100px"> </a>
        </div>
        <div class="register-box-body">
            <h4> <p class="login-box-msg"> Registro de venta de Dulces </p> </h4>
