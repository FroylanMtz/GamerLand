...
<head>
  ...
  <title>Rincón del Gamer - Ventas</title>
      ...
      success: function (returndata) {
        ...
        if(returndata[0].error==0){
          ...
          for (i = 0; i < returndata[1].length; i++) {
            if (contador%2!=0) {
            rJson = rJson + " <tbody>  <tr style=background-color:#A9ABAA;><td>" + returndata[1][i].nombre + "</td><td>" + returndata[1][i].usuario + "</td><td>" + returndata[1][i].cantidad + "</td>";
            rJson = rJson + "</tr>";
          }else{
            rJson = rJson + " <tbody>  <tr style=background-color:#f2f2f2;><td>" + returndata[1][i].nombre + "</td><td>" + returndata[1][i].usuario + "</td><td>" + returndata[1][i].cantidad + "</td>";
            rJson = rJson + "</tr>";
          }
          contador++;
          }
