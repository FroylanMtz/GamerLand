      ...
      success: function (returndata) {
        ...
        if(returndata[0].error==0){
          ...
          for (i = 0; i < returndata[1].length; i++) {
            if (contador%2!=0){ 
            rJson = rJson + " <tbody>  <tr style=background-color:#f2f2f2;  id='tr"+returndata[1][i].idUsuario+"'><td >" + returndata[1][i].nombre + "</td><td>" + returndata[1][i].aPaterno + "</td><td>" + returndata[1][i].aMaterno + "</td><td>" +  returndata[1][i].usuario + "</td>";
            ...
            rJson = rJson + " <tbody>  <tr style=background-color:#A9ABAA;  id='tr"+returndata[1][i].idUsuario+"'><td >" + returndata[1][i].nombre + "</td><td>" + returndata[1][i].aPaterno + "</td><td>" + returndata[1][i].aMaterno + "</td><td>" +  returndata[1][i].usuario + "</td>";
            if((returndata[1][i].idRol)==1){
              rJson = rJson + "<td>Administrador</td>";
            }else if((returndata[1][i].idRol)==2){
              rJson = rJson + "<td>Gamer</td>";
