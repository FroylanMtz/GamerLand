      ...
      success: function (returndata) {
        ...
        if(returndata[0].error==0){
          ...
          for (i = 0; i < returndata[1].length; i++) {
            if (contador%2!=0) {
            rJson = rJson + " <tbody>  <tr style=background-color:#f2f2f2; id='tr"+returndata[1][i].idConsola+"'><td>" + returndata[1][i].nombre + "</td><td>" + returndata[1][i].nombrePla + "</td><td>" + returndata[1][i].numero + "</td><td>" + returndata[1][i].seriall + "</td><td>" + returndata[1][i].costo + "</td><td>" + returndata[1][i].costoMonedas + "</td><td>" + returndata[1][i].premioMonedas + "</td>";
            ...
            rJson = rJson + "</tr>";
             ...
             rJson = rJson + " <tbody>  <tr style=background-color:#A9ABAA; id='tr"+returndata[1][i].idConsola+"'><td>" + returndata[1][i].nombre + "</td><td>" + returndata[1][i].nombrePla + "</td><td>" + returndata[1][i].numero + "</td><td>" + returndata[1][i].seriall + "</td><td>" + returndata[1][i].costo + "</td><td>" + returndata[1][i].costoMonedas + "</td><td>" + returndata[1][i].premioMonedas + "</td>";
            rJson = rJson + "<th><a href='addConsola.php?ccc="+returndata[1][i].idConsola+"' target='_self' class='btn btn-primary btn-block boton'>EDITAR</a></th>";
            rJson = rJson + "<th><a href='#' target='_self' data-id='"+returndata[1][i].idConsola+"' class='link_eliminar btn btn-danger btn-block boton'>ELIMINAR</a></th>";
            rJson = rJson + "</tr>";
          }
