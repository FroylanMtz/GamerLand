      ...
      success: function (returndata) {
        ...
        if(returndata[0].error==0){
          ...
          for (i = 0; i < returndata[1].length; i++) {
            rJson = rJson + " <tbody>  <tr id='tr"+returndata[1][i].idJuego+"-"+returndata[1][i].idConsola+"'><td>" + returndata[1][i].nombre + "</td><td>" + returndata[1][i].nombreCon + "</td><td>" + returndata[1][i].nombrePla + "</td>";
