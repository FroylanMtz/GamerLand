      ...
      success: function (returndata) {
        ...
        if(returndata[0].error==0){
          ...
          for (i = 0; i < returndata[1].length; i++) {
            rJson = rJson + " <tbody>  <tr id='tr"+returndata[1][i].idJuego+"-"+returndata[1][i].idConsola+0"'><td>" + returndata[1][i].nombre + "</td><td>" + returndata[1][i].nombreCon + "</td><td>" + returndata[1][i].nombrePla + "</td>";
            if(returndata[1][i].rutaFoto != ""){
              rJson = rJson + "<td><img style='border-radius: 25px;' width='80' height='80' src="+returndata[1][i].rutaFoto+" alt='Imagen'></td>"
            }else{
              rJson = rJson + "<td>Sin Foto</td>"
            }
            rJson = rJson + "<th><a href='addJuego.php?jjj="+returndata[1][i].idJuego+"-"+returndata[1][i].idConsola+"' target='_self' class='btn btn-primary btn-block boton'>EDITAR</a></th>";
            rJson = rJson + "<th><a href='#' target='_self' data-id='"+returndata[1][i].idJuego+"-"+returndata[1][i].idConsola+"' class='link_eliminar btn btn-danger btn-block boton'>ELIMINAR</a></th>";
            rJson = rJson + "</tr>";
          }
                ...
                success: function (returndata) {
                  if(returndata == 1){
                    swal.fire({
                      ...
                      text: "Un juego fue eliminado con éxito.",
