      ...
      success: function (returndata) {
        ...
        if(returndata[0].error==0){
          ...
          for (i = 0; i < returndata[1].length; i++) {
            if (contador%2!=0) {
            rJson = rJson + " <tbody>  <tr style=background-color:#A9ABAA; id='tr"+returndata[1][i].idAccesorio+"'><td>" + returndata[1][i].nombre + "</td><td>" + returndata[1][i].costo + "</td>";
            ...
            rJson = rJson + " <tbody>  <tr style=background-color:#f2f2f2; id='tr"+returndata[1][i].idAccesorio+"'><td>" + returndata[1][i].nombre + "</td><td>" + returndata[1][i].costo + "</td>";
            rJson = rJson + "<th><a href='addAccesorio.php?aaa="+returndata[1][i].idAccesorio+"' target='_self' class='btn btn-primary btn-block boton'>EDITAR</a></th>";
            rJson = rJson + "<th><a href='#' target='_self' data-id='"+returndata[1][i].idAccesorio+"' class='link_eliminar btn btn-danger btn-block boton'>ELIMINAR</a></th>";
            rJson = rJson + "</tr>";
          }
